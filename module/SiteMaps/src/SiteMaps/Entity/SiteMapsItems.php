 ...
 * @ORM\Entity
 */
class SiteMapsItems extends ComponentItems
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection $siteMapsData
     *
     * @ORM\OneToOne(targetEntity="SiteMaps\Entity\SiteMap", mappedBy="item", cascade={"all"})
     */
    protected $siteMapsData;
}