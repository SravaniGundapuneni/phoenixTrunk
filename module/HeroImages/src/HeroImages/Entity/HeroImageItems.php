 ...
 * @ORM\Entity
 */
class HeroImageItems extends ComponentItems
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection $heroImagesData
     *
     * @ORM\OneToOne(targetEntity="HeroImages\Entity\HeroImages", mappedBy="item", cascade={"all"})
     */
    protected $heroImagesData;
}