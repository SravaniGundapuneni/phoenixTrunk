 ...
 * @ORM\Entity
 */
class PagesItems extends ComponentItems
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection $pagesData
     *
     * @ORM\OneToOne(targetEntity="Pages\Entity\Pages", mappedBy="item", cascade={"all"})
     */
    protected $pagesData;
}