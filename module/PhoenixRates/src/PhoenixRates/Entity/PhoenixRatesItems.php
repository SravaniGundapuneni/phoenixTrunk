 ...
 * @ORM\Entity
 */
class PhoenixRatesItems extends ComponentItems
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection $phoenixRatesData
     *
     * @ORM\OneToOne(targetEntity="PhoenixRates\Entity\PhoenixRate", mappedBy="item", cascade={"all"})
     */
    protected $phoenixRatesData;
}