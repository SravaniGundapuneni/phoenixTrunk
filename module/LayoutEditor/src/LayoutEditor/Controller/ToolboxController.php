...
class ToolboxController extends AbstractActionController {
    ...
    public function indexAction()
    {
		...
		$viewModel->moduleName = 'LayoutEditor';
		...
		$renderer = $this->getServiceLocator()->get('Zend\View\Renderer\PhpRenderer');
                ...
                $renderer->headLink()->appendStylesheet($viewModel->toolboxIncludeUrl . 'module/LayoutEditor/view/layout-editor/toolbox/css/jquery.gridmanager.css');
                ...
                $renderer->HeadScript()->appendFile($viewModel->toolboxIncludeUrl . 'module/LayoutEditor/view/layout-editor/toolbox/js/jquery.gridmanager.js','text/javascript');
                ...
                $renderer->HeadScript()->appendFile($viewModel->toolboxIncludeUrl . 'module/LayoutEditor/view/layout-editor/toolbox/js/layout-editor.js','text/javascript');
