...
// TODO: This should be dynamic, i.e. handled by a build script

//$baseUrl = 'http://localhost/loews/d/';
//$baseUrl = $_SESSION["config_baseurl"]."d/";
$baseUrl =  $_SESSION["SITEROOT_CONFIG"]."d/";
...
ATTENTION: The trailing slash is required.
TODO: this should be handled by a build script
*/
//$baseDir = '/htb_webcontent/phxfoundation/httpdocs/d/';
//$baseDir = 'D:/www/loews/d/';
$baseDir = $_SESSION["SITEPATH_CONFIG"]."/d/";
/*
 * ### Advanced Settings
 */
...
if(isset($_SESSION["skipFolders"]) && !empty($_SESSION["skipFolders"])){
	foreach($_SESSION["skipFolders"] as $skipfol){
		$config['ResourceType'][] = $skipfol;
	}
}
...
include_once "plugins/attachments/plugin.php";
include_once "plugins/dbsavenewfiles/plugin.php";
