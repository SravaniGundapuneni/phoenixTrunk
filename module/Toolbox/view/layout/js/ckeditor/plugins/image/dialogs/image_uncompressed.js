            ...
            w = function () {
                ...
                if (a == f) {
                    var e = this.getDialog(),
                        c = "",
                        g = "txtWidth" == this.id ? "max-width" : "max-height",
                        h = b.getAttribute(g);
                    h && (c = d(h, c));
                    c = d(b.getStyle(g), c);
                    this.setValue(c)
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    commit: function (a, b, d) {
                                        ...
                                        if(c > 2000)
                                        {
                                            alert("Image width is too high!");
                                        }
                                        a == f ? (c ? b.setStyle("max-width", CKEDITOR.tools.cssLength(c)) : b.removeStyle("width"), !d && b.removeAttribute("width")) : 4 == a ? c.match(k) ? b.setStyle("max-width", CKEDITOR.tools.cssLength(c)) : (a = this.getDialog().originalElement, "true" == a.getCustomData("isReady") && b.setStyle("max-width", a.$.width + "px")) : 8 == a && (b.removeAttribute("width"), b.removeStyle("width"))
                                    }
                                }, {
                                    type: "text",
                                    id: "txtHeight",
                                    ...
                                    commit: function (a, b, d) {
                                        var c = this.getValue();
                                        a == f ? (c ? b.setStyle("max-height", CKEDITOR.tools.cssLength(c)) : b.removeStyle("height"), !d && b.removeAttribute("height")) : 4 == a ? c.match(k) ? b.setStyle("max-height", CKEDITOR.tools.cssLength(c)) : (a = this.getDialog().originalElement,
                                            "true" == a.getCustomData("isReady") && b.setStyle("max-height", a.$.height + "px")) : 8 == a && (b.removeAttribute("height"), b.removeStyle("height"))
                                    }
                                }]
                            }, {
                                id: "ratioLock",
