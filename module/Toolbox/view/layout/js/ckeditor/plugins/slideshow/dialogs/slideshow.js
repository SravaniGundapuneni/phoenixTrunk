...
function removeThumbFromURL(string) {
	if( string.indexOf("__thumbs")> -1 ){
		imageFileName=string.substring(string.lastIndexOf("/") + 1);
		firstPartOfImage=string.substring( 0,string.indexOf("__thumbs") );
		return firstPartOfImage+imageFileName;
	} else {
		return string;
	}
}
...
SCRIPT_ADDGAL =  pluginPath+"3rdParty/ad-gallery/jquery.ad-gallery.js",
...
//		var height = 443;
		...
		var iframe = CKEDITOR.dom.element.createFromHtml( '<iframe' +
				' style="width:'+w+'px;height:'+h+'px;background:#ddd; "'+
...
//		str += "});";
	...
	function feedUlWithImages(dialog, ulObj) {
		...
		for ( var i = 0; i < dialog.imagesList.length  ; i++ ) {
			...
			aObj.setAttribute( 'data-fancybox-href', removeThumbFromURL(dialog.imagesList[i][IMG_PARAM.URL]) );
			aObj.setAttribute('contenteditable', 'false');
			aObj.setAttribute( 'data-fancybox-group', 'ad-gallery_'+dialog.params[0][1]);
			aObj.setAttribute( 'class', 'fancyboxImage imageNumber'+i);
	...
	function ClickOkBtn(dialog) {
		...
		extraStyles.backgroundSize = '100% 75%';
				...
				elements: [
                                            ...
                                            },
                                            {
                                                    ...
                                                    filebrowser :
                                                    {
                                                            ...
                                                            url: editor.config.filebrowserImageBrowseUrl_slideshow || editor.config.filebrowserBrowseUrl,
                                                    },
                                                    label : lang.imgAdd,
...
//                                                                                                type : 'select',
//                                                                                                id : 'slideshowtypeid',
//                                                                                                label : lang.slideshow,
//                                                                                                  // add-gallery effects 'slide-vert', 'resize', 'fade', 'none' or false
//                                                                                                  // effect: 'slide-hori',
//                                                                                                items : [ [ lang.ss1, 'HomePage' ], [ lang.ss2, 'Sub-page' ], [ lang.ss3, 'Round Button' ] ],
//                                                                                                'default' : 'default',
//                                                                                                style : 'width:100px;',
//                                                                                                commit : commitValue,
//                                                                                                setup : loadValue,
