            ...
            basePath: function () {
                ...
                if (!b)
                    for (var d = document.getElementsByTagName("script"), a = 0; a < d.length; a++) {
                        var e = d[a].src.match(/(^|.*[\\\/])ckeditor_toolbox(?:_basic)?(?:_source)?.js(?:\?.*)?$/i);
                        if (e) {
                            b = e[1];
                            break
                        }
    ...
    "unloaded" == CKEDITOR.status && function () {
        ...
        CKEDITOR.loadFullCore = function () {
            if (CKEDITOR.status != "basic_ready") CKEDITOR.loadFullCore._load = 1;
                ...
                a.src = CKEDITOR.basePath + "ckeditor_toolbox.js";
...
//          var dialogDefinition = ev.data.definition;
    ...
    CKEDITOR.config = {
        customConfig: "config_toolbox.js",
        autoUpdateElement: !0,
        language: "",
        defaultLanguage: "en",
...
*/
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("image", {
            ...
            init: function (b) {
                if (!b.plugins.image2) {
                    CKEDITOR.dialog.add("image", this.path + "dialogs/image_uncompressed.js");
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function () {
                function a(a) {
                    // modified padding  : 0
                    return ".%1.%2 p,.%1.%2 div,.%1.%2 pre,.%1.%2 address,.%1.%2 blockquote,.%1.%2 h1,.%1.%2 h2,.%1.%2 h3,.%1.%2 h4,.%1.%2 h5,.%1.%2 h6{padding-%3: 0px;}".replace(/%1/g,
                        "cke_show_blocks").replace(/%2/g, "cke_contents_" + a).replace(/%3/g, "rtl" == a ? "right" : "left")
                }
                // modified background image : none
                CKEDITOR.addCss(".%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;outline: 1px dotted gray;padding-top: 0px;box-shadow: inset 0 1px 4px rgba(0,0,0,.05);background: rgba(0,0,0,.03);}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}".replace(/%1/g,
                    "background-image: none").replace(/%2/g, "cke_show_blocks ") + a("ltr") + a("rtl"))
            },
            init: function (a) {
                if (!a.blockless) {
