 ...
 * @ORM\Entity
 */
class PhoenixRoomsItems extends ComponentItems
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var \Doctrine\Common\Collections\Collection $phoenixRoomsData
     *
     * @ORM\OneToOne(targetEntity="PhoenixRooms\Entity\PhoenixRoom", mappedBy="item", cascade={"all"})
     */
    protected $phoenixRoomsData;
}