...
use \Doctrine\ORM\Mapping as ORM;
  ...
  * @ORM\Entity
  */
class PhoenixRoom extends \ListModule\Entity\Entity
{
    /**
     * @var integer id
     *
    ...
    /**
     * @var PhoenixRooms\Entity\PhoenixRoomsItems $item
     *
     * @ORM\OneToOne(targetEntity="PhoenixRooms\Entity\PhoenixRoomsItems", inversedBy="phoenixRoomsData", cascade="persist")
