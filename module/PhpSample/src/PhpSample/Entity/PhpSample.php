 ...
 * PhpSampler
 *
 * @ORM\Table(name="phpSample")
 * @ORM\Entity
 */
class PhpSample extends \ListModule\Entity\Entity
{
    /**
     * @var integer id
     *
     ...
     *
     * @ORM\OneToOne(targetEntity="PhpSample\Entity\PhpSamplerItems", inversedBy="phpSampleData", cascade="persist")
