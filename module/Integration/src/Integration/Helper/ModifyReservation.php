...
class ModifyReservation extends AbstractHelper
{
    ...
    */
    ...
    public function __invoke($propertyId, $params, $behalf = array(), $dump_params = false)
    {
           ...
           $theConfnum = $params['confirmation_number'];
        ...
        if ($property = $this->phoenixProperties->getProperty($propertyId))
        {
            ...
            else
            {
                ...
                foreach ($params['reservation_rooms'] as $key => $room)
                {
                    ...
                    $params['confirmation_number'] = $theConfnum;
                    

                    $reservation = $this->integrationManager->modifyBooking( $params );
