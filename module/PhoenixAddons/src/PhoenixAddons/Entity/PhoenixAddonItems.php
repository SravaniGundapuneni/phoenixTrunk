 ...
 * @ORM\Entity
 */
class PhoenixAddonItems extends ComponentItems
{
    /**
     * @var integer id
     *
     ...
     *
     * @ORM\OneToOne(targetEntity="PhoenixAddons\Entity\PhoenixAddon", mappedBy="item", cascade={"all"})
     */
    protected $phoenixAddonData;
}